...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset001_BraTS2023/nnUNetTrainer__nnUNetPlans__2d'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset002_BraTS2023_valid/imagesTr'),
                                 join(nnUNet_raw, 'Dataset002_BraTS2023_valid/labelsTr_2d'),
