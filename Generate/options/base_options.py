...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', type=str, default='resvit_many',
                                 help='chooses which model to use. resvit_many, resvit_one, or test')
        ...
        self.parser.add_argument('--vit_name', type=str, default='Res-ViT-B_16',help='vit type')
